...
int eliminar(){
    ...
    if (cab != NULL)
    {
        ...
        cout<<"Cual es el ID del producto a eliminar?: ";
        cin>>id;
...
int buscar(){
    ...
    if (cab != NULL)
    {
        ...
        for (aux = cab; aux != NULL; aux=aux->sig){
            ...
            cout<<"-----------------------"<<endl;
            cout<<"El producto encontrado es: "<<cab->nombre<<endl;
            cout<<"ID: "<<cab->ID<<endl;
            cout<<"Cantidades disponibles: "<<cab->cantidad<<endl;
            cout<<"Precio (C/U): "<<cab->precio<<endl;
    ...
    {  
        ...
        for(aux=cab; aux!=NULL; aux = aux->sig){
            ...
            if(aux->ID==venta){
                ...
                cout<<"Cuanta cantidad desea vender?: ";
                cin>>cant;
                ...
                {
                    cout<<"No hay esa cantidad de producto."<<endl;
                }
